...
const links = [
    ...
    },
    {
        ...
        excerpt:
            'Brunch is one of my favorite activities so whenever I can, I like to visit a new local eatery. Below are 9 of the best restaurants in Kingston, Jamaica I have visited, perfect for brunch with the fam, friends, or that special someone. Fromage tops the list. Fromage Gourmet Market...', // Short summary
        url: 'https://www.gatsbyjs.com/docs/tutorial', // URL to the full post
    },
    {
    ...
    },
    {
        ...
        readTime: '5 min read', // Estimated read time
        excerpt:
            'The “extra” Ordinary- Throw all your other skincare products away! MAY 6, 2021 / AFTERNOONT Whether you’ve always had skin issues or have noticed negative changes in your skin due to significant life changes (hello, COVID), you may be able to relate to what I experienced last year: a skin midlife crisis. That...', // Short summary
        url: 'https://www.gatsbyjs.com/docs/tutorial', // URL to the full post
    },
    {
        ...
        readTime: '5 min read', // Estimated read time
        excerpt:
            'As humans, we sometimes get to the desperate point of needing something deeper. Just to keep on living. Some people find themselves through their work, children, or partners. Some in charity, art, whatever it may be. Others can’t seem to find it, or have yet to find it, a constant...', // Short summary
        url: 'https://www.gatsbyjs.com/docs/tutorial', // URL to the full post
    },
]
