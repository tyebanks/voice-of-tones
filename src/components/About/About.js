...
import authorImage from '../../images/author-four.jpg'

const WelcomeMsg = () => (
    <section className={styles.welcomeMsg}>
        <p>
            {' '}
...
const AuthorBio = () => (
    <section className={styles.authorBio}>
        <div className={styles.imgBox}>
            <img className={styles.authorImg} src={authorImage} alt="Author" />
        </div>
...
const BlogFocus = () => (
    <section className={styles.blogFocus}>
        <h2>Blog Focus</h2>
        ...
        <p>
            ...
            here BUT I decided to do it anyway.
        </p>
        <p>
            Voice of Tones blog will explore many of my personal interests,
            sharing my thoughts and experiences along the way. The focus of this
            blog will include:
        </p>
        ...
        <p>
            ...
            at all here, feel free to revisit.
        </p>
        <p>
            Lastly, in addition to my written blog posts, I may share my video
            content from time to time, so please stay tuned for my latest
            updates!
        </p>
        <p>- Tones</p>
    </section>
